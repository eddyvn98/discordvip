  ...
  return (
    <Card>
      ...
      <CardContent className="p-0">
        <div className="max-h-[480px] overflow-y-auto scrollbar-thin scrollbar-thumb-accent">
          <Table>
            <TableHeader className="sticky top-0 bg-card z-10 shadow-sm">
              <TableRow>
                <TableHead className="pl-6 bg-card">Thời gian</TableHead>
                <TableHead className="bg-card">Kênh</TableHead>
                <TableHead className="bg-card">Trạng thái</TableHead>
                <TableHead className="bg-card">Tiến độ</TableHead>
                <TableHead className="text-right pr-6 bg-card">Thao tác</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {jobs.map((job) => {
