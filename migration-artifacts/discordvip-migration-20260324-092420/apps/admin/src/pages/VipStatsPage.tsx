      ...
      {data?.platforms.map((platform) => (
        <section className="card vip-platform-card" key={platform.platform}>
          ...
          <div className="vip-inline-grid">
            ...
            <InlineMetric label="Paid auto" value={platform.paidAutoCount} />
            <InlineMetric label="Paid admin confirm" value={platform.paidManualOrderCount} />
            <InlineMetric label="Paid admin grant" value={platform.paidAdminGrantCount} />
