  ...
  return (
    <section className="card">
      <div className="section-header">
        <div>
          <h1>Mã khuyến mãi</h1>
          <p>Tạo và quản lý mã redeem VIP dùng chung cho Discord và Telegram.</p>
        </div>
      </div>
            ...
            return [
              ...
              <div className="promo-usage-cell">
                <input
                  ...
                  inputMode="numeric"
                />
                <span>{`Tổng ${item.usedCount}`}</span>
              </div>,
              <span>{item.discordUsedCount}</span>,
              <span>{item.telegramUsedCount}</span>,
              <input
                type="datetime-local"
